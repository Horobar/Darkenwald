/**
  Dieses Skript dient einzig der Vollständigkeit, die Datenbank selbst wird autonom vom Programm über Hibernate erstellt.
  Es wurde am Anfang als in-memory-h2 Datenbank verwendet.
 */
# CREATE DATABASE IF NOT EXISTS DARKENWALD_DB;
